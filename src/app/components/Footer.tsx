                ...
                <div className="flex flex-col">
                    ...
                    <form className="mt-4" onSubmit={handleSubmit}>
                        <input
                            ...
                            required
                            className="w-full p-2 mb-2 bg-gray-700 border border-gray-600 rounded focus:border-blue-500 outline-none"
                        />
                        <input
                            type="email"
                            name="email"
                        ...
                        <button
                            type="submit"
                            disabled={isPending}
                            className="w-full px-4 py-2 bg-blue-600 rounded hover:bg-blue-700 disabled:bg-blue-800 disabled:cursor-not-allowed transition-colors"
                        >
